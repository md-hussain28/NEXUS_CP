        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-xs text-[#00FF41]">HORIZON_ACTIVE</span>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            />
            <div className="font-mono text-lg text-[#00FFFF] opacity-90">Comprehensive Skill Development</div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-1">
              <HolographicCard className="p-6">
                ...
                <div className="space-y-4">
                  <SkillMetric label="MAPPED_SKILLS" value={userData?.topicData?.length || 8} />
              ...
              <div className="mt-6 space-y-4">
                <SkillBranch
                  ...
                  mastery={75}
                  subskills={["Greedy Algorithms", "Divide and Conquer", "Dynamic Programming"]}
                />
            ...
            <div className="lg:col-span-3">
              <Tabs defaultValue="skill-map" className="w-full" onValueChange={setActiveTab}>
                ...
                <TabsContent value="skill-map" className="mt-6">
                  <HolographicCard className="p-6 mb-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="font-mono text-[#00FFFF]">CURRENT_SKILL_LANDSCAPE</div>
                    ...
                    <div className="mt-4 font-mono text-xs text-white/70 text-center">
                      Your current skill landscape. Brighter nodes represent higher mastery levels.
                    </div>
                  </HolographicCard>
                ...
                <TabsContent value="expansion-paths" className="mt-6">
                  <HolographicCard className="p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <div className="font-mono text-[#00FFFF]">SKILL_EXPANSION_PATHS</div>
                    </div>
                    ...
                    <div className="space-y-6">
                      <ExpansionPath
                        ...
                        targetLevel="Expert"
                        requiredSkills={["Basic Graph Theory", "Shortest Path Algorithms", "Dynamic Programming"]}
                        expansionSteps={[
                      ...
                      <ExpansionPath
                        ...
                        currentLevel="Intermediate"
                        targetLevel="Expert"
                        requiredSkills={["Basic Data Structures", "Trees", "Heaps"]}
                        expansionSteps={["Segment Trees", "Fenwick Trees", "Sparse Tables"]}
                      />
                      ...
                      <ExpansionPath
                        ...
                        requiredSkills={["Basic String Manipulation", "Arrays", "Dynamic Programming"]}
                        expansionSteps={["KMP Algorithm", "Suffix Arrays", "Aho-Corasick Algorithm"]}
                      />
                    </div>
                  </HolographicCard>
                </TabsContent>
                ...
                <TabsContent value="cross-topic" className="mt-6">
                  <HolographicCard className="p-6">
                    <div className="flex items-center mb-4">
                      ...
                      <div className="font-mono text-[#00FFFF]">CROSS_TOPIC_CHALLENGES</div>
                    </div>
                    ...
                    <div className="space-y-6">
                      <CrossTopicChallenge
                        ...
                        difficulty="Hard"
                        requiredSkills={["Graph Theory", "Dynamic Programming", "Shortest Path Algorithms"]}
                        recommendedProblems={[
                          { name: "Longest Path in DAG", platform: "CodeForces" },
                          { name: "Minimum Path Sum", platform: "LeetCode" },
                          { name: "Cheapest Flights Within K Stops", platform: "LeetCode" },
                        ]}
                      />
                      ...
                      <CrossTopicChallenge
                        ...
                        recommendedProblems={[
                          { name: "Maximum XOR of Two Numbers in an Array", platform: "LeetCode" },
                          { name: "Bitwise AND of Numbers Range", platform: "LeetCode" },
                          { name: "Binary Tree Maximum XOR Path", platform: "CodeForces" },
                        ]}
                      />
                      ...
                      <CrossTopicChallenge
                        ...
                        difficulty="Hard"
                        requiredSkills={["String Manipulation", "Dynamic Programming", "Pattern Matching"]}
                        recommendedProblems={[
                          { name: "Longest Palindromic Substring", platform: "LeetCode" },
                          { name: "Edit Distance", platform: "LeetCode" },
                          { name: "Regular Expression Matching", platform: "LeetCode" },
                        ]}
                      />
                    </div>
                  </HolographicCard>
...
function SkillBranch({
  ...
  return (
    <div className="border border-white/10 bg-[#0D1117]/80 rounded-lg p-4 hover:border-[#00FFFF] transition-colors">
      ...
      <div className="mb-2">
        <div className="h-1 bg-white/10 rounded-full overflow-hidden">
          <div className="h-full bg-gradient-to-r from-[#00FF41] to-[#00FFFF]" style={{ width: `${mastery}%` }}></div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        {subskills.map((skill, index) => (
          <div key={index} className="px-2 py-0.5 bg-white/10 rounded font-mono text-xs text-white/80">
            {skill}
          </div>
        ))}
      </div>
    ...
    <div className="border border-[#00FFFF]/20 rounded-lg p-4 bg-[#0D1117]/50">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center">
          <div className="font-mono text-xs text-white/50 mr-2">{currentLevel}</div>
          <div className="w-16 h-1 bg-white/10 rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-[#00FF41] to-[#00FFFF] w-1/2"></div>
          </div>
          <div className="font-mono text-xs text-[#00FFFF] ml-2">{targetLevel}</div>
        </div>
      </div>
      ...
      <div className="mb-3">
        <div className="font-mono text-xs text-[#00FFFF] mb-1">REQUIRED_SKILLS:</div>
        <div className="flex flex-wrap gap-2">
          {requiredSkills.map((skill, index) => (
            <div key={index} className="px-2 py-0.5 bg-[#00FF41]/10 rounded font-mono text-xs text-[#00FF41]">
              {skill}
            </div>
          ))}
        </div>
      ...
      <div>
        <div className="font-mono text-xs text-[#00FFFF] mb-1">EXPANSION_STEPS:</div>
...
function CrossTopicChallenge({
  ...
  return (
    <div className="border border-[#00FFFF]/20 rounded-lg p-4 bg-[#0D1117]/50">
      ...
      <div>
        <div className="font-mono text-xs text-[#00FFFF] mb-1">RECOMMENDED_PROBLEMS:</div>
        <div className="space-y-2">
